...
'''
Drowsiness Detection with computer vision using dlib custom eye predictor
Author: Mario Ezzat
'''
# ==============================================================================
# -- Imports -------------------------------------------------------------------
...
# -- Dlib Face Detector --------------------------------------------------------
# ==============================================================================
dlib_face = shape_predictor("eye_predictor.dat")
...
def Get_Eye(face_landmark_part):
    right_eye = array([(face_landmark_part(0).x, face_landmark_part(0).y),
                        (face_landmark_part(1).x, face_landmark_part(1).y),
                        (face_landmark_part(2).x, face_landmark_part(2).y),
                        (face_landmark_part(3).x, face_landmark_part(3).y),
                        (face_landmark_part(4).x, face_landmark_part(4).y),
                        (face_landmark_part(5).x, face_landmark_part(5).y)])
    left_eye = array([(face_landmark_part(6).x, face_landmark_part(6).y),
                        (face_landmark_part(7).x, face_landmark_part(7).y),
                        (face_landmark_part(8).x, face_landmark_part(8).y),
                        (face_landmark_part(9).x, face_landmark_part(9).y),
                        (face_landmark_part(10).x, face_landmark_part(10).y),
                        (face_landmark_part(11).x, face_landmark_part(11).y)])
